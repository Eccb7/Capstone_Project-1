...
# 📖 [CAPSTONE_PROJECT-1] <a name="about-project"></a>
...
```sh
  cd hello Capstone
  git clone https://github.com/Eccb7/Capstone_Project-1
```
...
- [ ] **It will give future updates on coming conferences**
- [ ] **It will have my downloadable materials of discussions**
...
I would like acknowledge th author this masterpiece design [Cindy Shin in Behance](https://www.behance.net/adagio07)
